...
class TinyNetworkDarts(nn.Module):
    ...
    def __init__(self, C, N, max_nodes, num_classes, search_space, affine, track_running_stats, depth=-1,
        ...
        self._C = C
        self._layerN = N    # number of stacked cell at each stage(default 1)
        self.max_nodes = max_nodes    # max nodes in each cell(default 4)
        ...
        # produce parameters following normal distribution(edges*types of operations)
